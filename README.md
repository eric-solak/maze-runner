...
```
maze-runner % mvn -q clean package 
```
...
```
maze-runner % java -jar target/mazerunner.jar -i ./examples/straight.maz.txt
4F
maze-runner %
```
...
```
maze-runner % java -jar target/mazerunner.jar -i ./examples/straight.maz.txt -p 4F
correct path
maze-runner %
```
